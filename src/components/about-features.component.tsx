...
function AboutFeatures({ showFeatures = true, showChap = true }: { showFeatures?: boolean; showChap?: boolean }) {
    ...
    return (
        <section className="about-features-section" aria-label="Why families choose us">
            <div className="container">
                ...
                {showChap && (
                    <div className="chap-centered-block">
                        <h3 className="partner-card-inner-title">
                            {t('evaluation.chap.name')}
                        </h3>
                        <a
                        ...
                        >
                            <img src={AcreditationLogo} alt="CHAP Seal of Accreditation" style={{ maxWidth: '260px' }} />
                        </a>
                    </div>
                )}
